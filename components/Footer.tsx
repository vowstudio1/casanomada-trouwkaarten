    ...
    <footer className="bg-brand-950 text-brand-200 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-white tracking-[0.2em] text-sm font-semibold uppercase mb-4">
              {SITE_NAME}
            </h3>
            <p className="text-sm text-brand-300 leading-relaxed">
              Luxe digitale trouwkaarten met RSVP, AI-tafelindeling en gastenboek.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="mailto:info@casanomadadigital.com" className="hover:text-white transition-colors">
                  info@casanomadadigital.com
                </a>
              </li>
            </ul>
          </div>
        </div>
        <div className="mt-10 pt-8 border-t border-brand-800 text-center text-xs text-brand-400">
